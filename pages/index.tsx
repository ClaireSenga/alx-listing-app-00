...
const API_URL = "https://your-api-url.com/properties"; // Replace with your real API
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        ...
        setProperties(response.data); // Make sure your API returns an array of property objects
      } catch (err) {
